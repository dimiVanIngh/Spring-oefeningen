...
class FiliaalServiceImpl implements FiliaalService {
	 ...
	 * @Override
	 * 
	 * @ModifyingTransactionalServiceMethod public void afschrijven(Filiaal
	 * filiaal) { filiaal.afschrijven(); // je wijzigt een entity binnen een
	 * transactie. // JPA wijzigt dan automatisch het bijbehorende record bij de
	 * commit }
	 */
