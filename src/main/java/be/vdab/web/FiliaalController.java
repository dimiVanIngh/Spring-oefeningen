...
@Controller
// Enkel browser requests: produces = MediaType.TEXT_HTML_VALUE
...
class FiliaalController {
	...
	/*
	 * @RequestMapping(method = RequestMethod.GET, params = "id") ModelAndView
	 * read(long id) { ModelAndView modelAndView = new
	 * ModelAndView(FILIAAL_VIEW); Filiaal filiaal = filiaalService.read(id); if
	 * (filiaal != null) { modelAndView.addObject(filiaal); } return
	 * modelAndView; }
	 */
